...
from rdflib.store.FOPLRelationalModel.BinaryRelationPartition import Table
from rdflib import Namespace, Literal, URIRef, Variable, BNode
from rdflib.term_utils import term2Letter
